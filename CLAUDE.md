...
- `src/apis/imgPrcApi.ts`: `api.d.ts`의 `components`, `operations`를 참조하여 타입 별칭 정의

## 참고 문서

- [coding-guideLine.md] - 코딩 가이드라인
- [QUASAR.md](QUASAR.md) - Quasar Flex 클래스, Gutter 사용법
- [Style.md](Style.md) - CSS flex 축약형 정리
